...
void renderAndSaveImage(const char *filename, const PhysicsWorldPtr &physicsWorld, Vector3 cameraCenter)
{
    ...
    frustum.transformedWithFunction([&](const Vector3 &point){
        return point + cameraCenter;
    });
...
void testFallingBoxWithCompoundFloor()
{
    ...
    renderAndSaveImage("testFallingBoxWithCompoundFloor.tga", physicsWorld, Vector3(0, 1, 5));
}
